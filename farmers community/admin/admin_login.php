...
<body>
  ...
  $result=mysqli_query($conn,$sql1);//conn remove
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card border-secondary">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" action="admin_login.php" method="post" autocomplete="off">
                                <div class="form-group">
                                    <label for="inputName">Username</label>
                                    <input type="text" class="form-control" id="inputUname" name="username" placeholder="Enter your email">
                                    <label for="inputName">Password</label>
                                    <input type="password" class="form-control" id="inputPass" name="password" placeholder="Enter your password">
                                </div>
                                <div class="form-group">
