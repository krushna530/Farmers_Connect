...
$sql1="select * from users where email='$email' and cpassword=$cpassword";
                        ...
                        <div class="card-body">
                            <form class="form" role="form" action="login.php" method="post" autocomplete="off">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="inputCpass" name="cpassword" placeholder="Enter your password">
                                </div>
                                <div class="form-group">
